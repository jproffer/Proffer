<?php /* Smarty version Smarty-3.1.7, created on 2013-03-08 11:17:06
		 compiled from "/home/firewall/www/vs.profferlabs.com/app/views/vhosts/default/Client/Projects/upload.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5139c8b2c0361',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5139c8b2c0361')) {function content_5139c8b2c0361($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("includes/headerless.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>

   <!-- The file upload form used as target for the file upload widget -->
    <form id="fileupload" action="/General/upload" method="POST" enctype="multipart/form-data">
        <!-- The fileupload-buttonbar contains buttons to add/delete files and start/cancel the upload -->
		<input type='hidden' name='project_id' id='project_id' value='<?php echo $_smarty_tpl->tpl_vars['project']->value->getID();?>
' />
		<input type='hidden' name='mobile_id' id='mobile_id' value='<?php echo $_smarty_tpl->tpl_vars['mobile_id']->value;?>
' />
