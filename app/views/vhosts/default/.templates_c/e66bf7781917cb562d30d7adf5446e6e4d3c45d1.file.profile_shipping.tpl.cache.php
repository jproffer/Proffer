<?php /* Smarty version Smarty-3.1.7, created on 2013-02-22 07:50:51
		 compiled from "/home/firewall/www/vs.profferlabs.com/app/views/vhosts/default/Client/Accounts/profile_shipping.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14689297085127235bc87ba1-94061723%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '14689297085127235bc87ba1-94061723',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5127235bcad38',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5127235bcad38')) {function content_5127235bcad38($_smarty_tpl) {?>				<div class="row">
					<div class="label">Location Name</div>
					<div class="field w200"><input class="w150 required" id="shipping_name" name="shipping_name" value="<?php echo $_smarty_tpl->tpl_vars['shipping']->value['profile']['fname'];?>
" type="text" placeholder="John"  /></div>
				</div>
				<div class="row">
					<div class="label">Address</div>
					<div class="field w300"><input class="w200 required" id="shipping_address" name="shipping_address" type="text" value="<?php echo $_smarty_tpl->tpl_vars['shipping']->value['profile']['address'];?>
" placeholder="100 somestreet ave." title="Address is required." /></div>
				</div>
				<div class="row">
					<div class="label">Address</div>
					<div class="field w300"><input class="w200" id="shipping_address2" name="shipping_address2" type="text" value="<?php echo $_smarty_tpl->tpl_vars['shipping']->value['profile']['address2'];?>
" placeholder="Suite 771" /></div>
				</div>
				<div class="row">
					<div class="label">City</div>
					<div class="field w300"><input class="w200 required" id="shipping_city" name="shipping_city" type="text" value="<?php echo $_smarty_tpl->tpl_vars['shipping']->value['profile']['city'];?>
" placeholder="Austin" title="City is required."  /></div>
				...
				<div class="row">
					...
					<div class="field w300" id="shipping_statefield">
						...
						<input class="w200 hidden required" id="shipping_fstate" name="shipping_fstate" type="text" value="<?php echo $_smarty_tpl->tpl_vars['shipping']->value['profile']['state'];?>
" placeholder="Enter state/province name" title="State/province is required." />
					</div>
				</div>
				<div class="row">
					<div class="label">Zip/Post Code</div>
					<div class="field w300"><input class="w100 required" id="shipping_zip" name="shipping_zip" type="text" value="<?php echo $_smarty_tpl->tpl_vars['shipping']->value['profile']['zip'];?>
" placeholder="78704" title="Postal is required."  /></div>
				...
				<div class="row">
					...
					<div class="field w200"><input class="w150 required" id="shipping_phone" name="shipping_phone" type="text" value="<?php echo $_smarty_tpl->tpl_vars['shipping']->value['profile']['phone'];?>
