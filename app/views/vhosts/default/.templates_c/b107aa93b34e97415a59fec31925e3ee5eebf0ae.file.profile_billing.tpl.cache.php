<?php /* Smarty version Smarty-3.1.7, created on 2013-02-22 07:50:51
		 compiled from "/home/firewall/www/vs.profferlabs.com/app/views/vhosts/default/Client/Accounts/profile_billing.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2017267495127235bcafe24-90397922%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2017267495127235bcafe24-90397922',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5127235bcdebc',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5127235bcdebc')) {function content_5127235bcdebc($_smarty_tpl) {?>				<div class="row">
					<div class="label"></div>
				...
				<div class="row">
					...
					<div class="field w200"><input class="w150 required" id="billing_fname" name="billing_fname" value="<?php echo $_smarty_tpl->tpl_vars['billing']->value['profile']['fname'];?>
" type="text" placeholder="John"  /></div>
					<div class="field w50"><input class="w20" id="billing_mi" name="billing_mi" type="text" placeholder="D" title="Middle Initial" size="2" value="<?php echo $_smarty_tpl->tpl_vars['billing']->value['profile']['mi'];?>
" maxlength="1" /></div>
					<div class="field w200"><input class="w150 required" id="billing_lname" name="billing_lname" type="text" value="<?php echo $_smarty_tpl->tpl_vars['billing']->value['profile']['lname'];?>
" placeholder="Smith" /></div>
				</div>
				<div class="row">
					<div class="label">Address</div>
					<div class="field w300"><input class="w200 required" id="billing_address" name="billing_address" type="text" value="<?php echo $_smarty_tpl->tpl_vars['billing']->value['profile']['address'];?>
" placeholder="100 somestreet ave." title="Address is required." /></div>
				</div>
				<div class="row">
					<div class="label">Address</div>
					<div class="field w300"><input class="w200" id="billing_address2" name="billing_address2" type="text" value="<?php echo $_smarty_tpl->tpl_vars['billing']->value['profile']['address2'];?>
" placeholder="Suite 771" /></div>
				</div>
				<div class="row">
					<div class="label">City</div>
					<div class="field w300"><input class="w200 required" id="billing_city" name="billing_city" type="text" value="<?php echo $_smarty_tpl->tpl_vars['billing']->value['profile']['city'];?>
" placeholder="Austin" title="City is required."  /></div>
				...
				<div class="row">
					...
					<div class="field w300" id="billing_statefield">
						...
						<input class="w200 hidden  required" id="billing_fstate" name="billing_fstate" type="text" value="<?php echo $_smarty_tpl->tpl_vars['billing']->value['profile']['state'];?>
" placeholder="Enter state/province name" title="State/province is required." />
					</div>
				</div>
				<div class="row">
					<div class="label">Zip/Post Code</div>
					<div class="field w300"><input class="w100 required" id="billing_zip" name="billing_zip" type="text" value="<?php echo $_smarty_tpl->tpl_vars['billing']->value['profile']['zip'];?>
" placeholder="78704" title="Postal is required."  /></div>
				...
				<div class="row">
					...
					<div class="field w200"><input class="w150 required" id="billing_phone" name="billing_phone" type="text" value="<?php echo $_smarty_tpl->tpl_vars['billing']->value['profile']['phone'];?>
