...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_513a545b5a831',
  'cache_lifetime' => 3600,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_513a545b5a831')) {function content_513a545b5a831($_smarty_tpl) {?><div id="toplong" class="panel">
	<form method='post' autocomplete="on" name='frmNewStoryboard' id='frmNewStoryboard'>
		
		<input type='hidden' name='pid' id='pid' value='90642' />
		<div class='section'>
			<div class="row">
